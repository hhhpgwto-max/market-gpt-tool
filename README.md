...
- `screen_a_share_research_candidates`：先按透明条件筛出研究池，再检查全市场涨跌家数和候选股 20/60 日历史持续性；按成交额而非当日涨幅决定补查顺序。证据不足、市场广度未过门槛或没有股票通过历史门槛时明确返回 `no_candidate=true`，不会为了回答而硬选一只股票。
